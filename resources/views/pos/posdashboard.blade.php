@extends('layouts.poslayout2') {{-- or layouts.app if you're using default auth layout --}}
...
<div class="max-w-7xl mx-auto px-6 py-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div class="bg-white p-6 rounded-2xl shadow text-center">
            ...
            <h2 class="text-2xl font-bold text-green-600 mt-2">23</h2>
        </div>
        <div class="bg-white p-6 rounded-2xl shadow text-center">
...
@endphp
        ...
        <div class="bg-white p-6 rounded-2xl shadow text-center">
            ...
            <h2 class="text-2xl font-bold text-yellow-600 mt-2">Rs. 18,500</h2>
        </div>
    </div>
